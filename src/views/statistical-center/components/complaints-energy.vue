    ...
    series: [
      {
        ...
        smooth: true,
        data:[
          10608,5980,1664,9412,5668,2392,8424,6084,2340,7592,
          2496,5772,7124,2132,4680,6968,5928,3640,29120,6136,2288,7384,6396,3276,
          3848,2080,6656,3796,2272,5252,8840,5408,13000,7852,1040,
          7020,7072,2600,6656,7228,484,1508,6552,2704,156
        ]
      },
      {
        name:'投诉量',
        ...
        data: [
          ...
          906,120,1224,690,192,1086,2616,684,420,3360,606,1020,624,1500
        ]
      }
    ]
  };
